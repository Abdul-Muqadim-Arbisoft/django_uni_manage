...
from .views import SignupView, LoginView, LogoutView, EditProfileView, ChangePasswordView, HomeView, ListUsersView, SignupAPIView, LoginAPIView,logout_api_view, EditProfileAPIView,ChangePasswordAPIView,ListUsersAPIView
